...
<p><strong>Изтриване</strong>. При щракване на бутона се изтрива думата от "Съществуваща дума" и номер на таблица от "Таблица". Ако в "Таблица" има повече номера, не се случва нищо.</p>
<p><strong>Преместване на дума в нова таблица</strong>. Думата трябва да е написана в "Нова дума", таблицата й, която ще се смени, трябва да е написана в "Таблица", а новата и таблица в "Нова таблица". Щраква се бутона "Добавяне или променяне на таблица".</p>
